            ...
            <div class="card">
                ...
                <div class="list-group list-group-flush" role="tablist">
                    <a class="list-group-item list-group-item-action active" data-toggle="list" href="#account" role="tab">
                        <i class="fa fa-list-alt" aria-hidden="true"></i> Datos generales del usuario
                    </a>
                    <a class="list-group-item list-group-item-action" data-toggle="list" href="#password" role="tab">
                        <i class="fa fa-unlock-alt" aria-hidden="true"></i> Contraseña
                    </a>
                    ...
                    @if(isset($user->party->party_role) && $user->party->party_role->role_type_id === "REPRESENTANTE_LEGAL")
                        <a class="list-group-item list-group-item-action " data-toggle="list" href="#paciente" role="tab">
                            <i class="fa fa-user" aria-hidden="true"></i> Datos generales del paciente
                        </a>
                    @endif
                </div>
            </div>
                        ...
                        <div class="card-body">
                            <form class="form-horizontal" id="form_datos_usuario">
                                ...
                                <div class="form-row">
                                    ...
                                    {{--@if(isset($u->party->party_role) && $u->party->party_role->role_type->role_type_id === "MEDICO_USUARIO")
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="fecha_nacimiento">Cuenta habilitada</label>
                                                <select class="form-control" id="cuenta_habilitada" name="cuenta_habilitada" required>
                                                    <option value="N" {{$u->enabled == "N" ? "selected" : ""}}>No</option>
                                                    <option value="Y" {{$u->enabled == "Y" ? "selected" : ""}}>Si</option>
                                                </select>
                                            </div>
                                        </div>
                                    @endif--}}
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <select class="form-control" id="pais_paciente" name="pais_paciente" required>
                                                    @foreach($pais as $p)
                                                        <option {{$geo == $p->geo_code ? "selected" : ""}} value="{{$p->geo_code}}">{{$p->geo_name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="form-group col-md-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="form_contrasena">
                                ...
                                <button type="button" class="btn btn-primary" onclick="actualizarContrasena('{{$partyId}}')">
                                    <i class="fa fa-floppy-o" aria-hidden="true"></i> Guardar
                                </button>
                            </form>
                        </div>
