        ...
        <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
                <div class="navbar-header"><a id="toggle-btn" href="#" class="menu-btn"><i class="icon-bars"> </i></a><a href="#" class="navbar-brand">
                        <div class="brand-text d-none d-md-inline-block"><span>{{isset(getConfiguracionEmpresa()->nombre_empresa) ? getConfiguracionEmpresa()->nombre_empresa : ""}}</span><strong class="text-primary">Dashboard</strong></div></a></div>
